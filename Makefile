all: main.o utils.o Matrix.o class_options.o
	g++ -o bin/main bin/main.o bin/utils.o bin/class_options.o bin/Matrix.o

main.o: main.cpp utils.o Matrix.o class_options.o
